$(document).ready(function () {
    ...
    $("div.container-fluid").LoadingOverlay("show");//Linea de codigo que muestra un grafico de "cargando"
    ...
    fetch("/DashBoard/ObtenerResumen")
        ...
        .then(responseJson => {
            if (responseJson.estado) {
                ...
                //Mostrar texto y valores para graficos de barra
                let barchart_labels;
                let barchart_data;
                ...
                //Mostrar texto y valores para graficos de pie
                let piechart_labels;
                let piechart_data;
