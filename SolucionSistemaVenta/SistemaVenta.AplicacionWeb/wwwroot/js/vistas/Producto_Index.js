...
$("#btnGuardar").click(function () {
    ...
    $("#modalData").find("div.modal-content").LoadingOverlay("show");//Linea de codigo que muestra un grafico de "cargando"
        ...
        fetch("/Producto/Crear", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    tablaData.row.add(reponseJson.objeto).draw(false)
        ...
        fetch("/Producto/Editar", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    $("#modalData").modal("hide")
                    swal("Listo!", "El producto fue moficado", "success")
                } else {
                    swal("Lo sentimos!", responseJson.mensaje, "error")
                }
            })
