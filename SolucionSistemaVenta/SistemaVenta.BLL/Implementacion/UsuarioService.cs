...
namespace SistemaVenta.BLL.Implementacion
{
    public class UsuarioService : IUsuarioService
    {
        ...
        public async Task<Usuario> ObtenerPorId(int idUsusario)
        {
            IQueryable<Usuario> query = await _repositorio.Consultar(u=>u.IdUsuario == idUsusario);   
        ...
        public Task<bool> GuardarPerfil(int entidad)
        {
            throw new NotImplementedException();
        }

        public Task<bool> CambiarClave(int idUsuario, int claveActual, string claveNueva)
        {
            throw new NotImplementedException();
        }
    }
