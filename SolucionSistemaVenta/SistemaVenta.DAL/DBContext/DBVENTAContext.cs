...
public partial class DBVENTAContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C2A7FB04B");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FE044CB67");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483A37DFEBF");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107A8C7AEE6");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E6877AF1A");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1325FF845F4");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76089E5561");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D83B1EF81D");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE5FE165AB");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6F989D7B6");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614F4570F10");
