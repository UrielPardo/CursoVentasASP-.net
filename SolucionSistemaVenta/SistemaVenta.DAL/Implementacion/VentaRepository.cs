        ...
        public async Task<Venta> Registrar(Venta entidad)
        {
            ...
            using (var transaction = _dbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    transaction.Commit();//Si no hay errores los registros temporales, se convierten en registros netos en las tablas
                                         //Si hay error, se ejecuta el catch con el rollback
                }
                catch (Exception ex)
                {
